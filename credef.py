...
plt.savefig("figures/credit_confusion_matrix.png")
plt.close()
...
plt.legend()
plt.title("ROC Curve")
plt.savefig("figures/credit_roc_curve.png")
plt.close()
...
plt.savefig("figures/credit_feature_importance.png")
plt.close()

plt.hist(scores[y_test == 1], alpha=0.6, label="Default")
plt.hist(scores[y_test == -1], alpha=0.6, label="No Default")
plt.legend()
plt.title("Decision Score Distribution")
plt.savefig("figures/credit_score_distribution.png")
plt.close()
...
with open("model/credit_default_model.json", "w") as f:
    json.dump({
...
print("\n✅ Credit Default training complete. Model and plots saved.")
